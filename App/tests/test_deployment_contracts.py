...
"""
    ...
    def test_public_frontend_build_fingerprints_immutable_assets(self) -> None:
        ...
        self.assertIn('src="/app.js?v=0.9.5"', public_html)
        ...
        self.assertIn("PUBLIC_APP_VERSION=0.9.5", public_env)
    ...
    def test_browser_ci_uses_preinstalled_allowlisted_chrome(self) -> None:
        ...
        self.assertEqual(frontend_tests.count("_launch_browser(playwright)"), 24)
