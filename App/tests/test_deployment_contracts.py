...
class DeploymentContractTests(TestCase):
    ...
    def test_public_frontend_build_fingerprints_immutable_assets(self) -> None:
        ...
        self.assertIn('href="/app.css?v=0.9.1"', public_html)
        self.assertIn('src="/app.js?v=0.9.1"', public_html)
        self.assertIn('href="/shared/immersive.css?v=0.9.1"', public_html)
        self.assertIn('src="/privacy/privacy.js?v=0.9.1"', privacy_html)
        self.assertIn("PUBLIC_APP_VERSION=0.9.1", public_env)
