...
class DeploymentContractTests(TestCase):
    ...
    def test_public_frontend_assets_are_not_cached_across_deployments(self) -> None:
        ...
        self.assertIn('href="/app.css?v=0.8.2"', public_html)
        self.assertIn('src="/app.js?v=0.8.2"', public_html)
        self.assertIn('href="/shared/immersive.css?v=0.8.2"', public_html)
        self.assertIn("PUBLIC_APP_VERSION=0.8.2", public_env)
