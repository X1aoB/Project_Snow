...
后续状态：S2 已于 07:24 UTC 在 blue 准备候选，尚未批准或晋级。原 blue/502 容器已被替换，其独立恢复锚点和镜像保留；控制器现为 c350963，公网仍是本次上线的 S1。以下保留 S1 操作当时的事实，最新状态见 [S2 候选验收记录](s2-candidate-20260908.md)。
