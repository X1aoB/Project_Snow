    ...
    with httpx.Client(headers=headers, follow_redirects=True, timeout=timeout) as client:
        ...
        for character in registry.get("characters", []):
            ...
            row = {
                ...
                "license_source_page": (selected_page or {}).get("canonical_url"),
                "source_revision_id": (selected_page or {}).get("revision_id"),
                "source_fetched_at": (selected_page or {}).get("fetched_at"),
                "page_specific_exception": bool((selected_page or {}).get("license_exception")),
                "publishable": False,
                "stage_src": None,
